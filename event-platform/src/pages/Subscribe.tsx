...
export function Subscribe() {
  ...
  async function createUserForm(event: FormEvent) {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center relative">
      <img src="/src/assets/react.svg" alt="" className="absolute mx-auto mt-4" />
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          <form className="flex flex-col gap-2 w-full" onSubmit={createUserForm}>
            <input
              type="text"
